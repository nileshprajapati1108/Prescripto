...
const Appointment = () => {
  ...
  const {
    ...
    getDoctorsData,
    userData,
  } = useContext(AppContext); // ✅ userData added
  ...
  const bookAppointment = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        ...
        { userId: userData._id, docId, slotDate, slotTime }, // ✅ userId added
        { headers: { token } }
      );
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button
            className="bg-[var(--primary)] text-white text-sm font-light px-14 py-3 rounded-full my-6"
